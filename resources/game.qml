...
Item {
    ...
    // ── Story data ──────────────────────────────────────────────────────────
    // Loaded from game_constants.json via C++ GameManager.getGameConstants().
    property var storyData: gameConstants.storyData !== undefined ? gameConstants.storyData : []
    ...
    readonly property int fastForwardIntervalMs: gameConstants.fastForwardIntervalMs !== undefined
                                                    ? gameConstants.fastForwardIntervalMs : 600
